      ...
      (0, _babelHelperVueJsxMergeProps2.default)([{
        ...
        on: {
          'before-enter': function beforeEnter($event) {
            ...
            _this3.handleMenuEnter.apply(_this3, [$event].concat(attrs));
          },
          'after-leave': function afterLeave($event) {
            ...
            _this3.handleMenuLeave.apply(_this3, [$event].concat(attrs));
          }
        }
      }]),
      [h(
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1f60c540_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(366);
