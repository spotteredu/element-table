      ...
      (0, _babelHelperVueJsxMergeProps2.default)([{
        ...
        on: {
          'scroll': function scroll($event) {
            ...
            _this.handleScroll.apply(_this, [$event].concat(attrs));
          }
        }
      }]),
      [[view]]
      ...
      (0, _babelHelperVueJsxMergeProps2.default)([{
        ...
        on: {
          'mousedown': function mousedown($event) {
            ...
            _this.clickTrackHandler.apply(_this, [$event].concat(attrs));
          }
        }
      }]),
      [h('div', (0, _babelHelperVueJsxMergeProps2.default)([{
        ref: 'thumb',
        ...
        on: {
          'mousedown': function mousedown($event) {
            ...
            _this.clickThumbHandler.apply(_this, [$event].concat(attrs));
          }
        }
      }]))]
    );
