...
exports.default = {
  ...
  render: function render(h) {
    ...
    var TEMPLATE_MAP = {
      prev: h('prev'),
      jumper: h('jumper'),
      pager: h('pager', (0, _babelHelperVueJsxMergeProps2.default)([{
        ...
        on: {
          'change': function change($event) {
            ...
            _this.handleCurrentChange.apply(_this, [$event].concat(attrs));
          }
        }
      }])),
      next: h('next'),
          ...
          (0, _babelHelperVueJsxMergeProps2.default)([{
            ...
            on: {
              'click': function click($event) {
                ...
                (_$parent = _this2.$parent).prev.apply(_$parent, [$event].concat(attrs));
              }
            }
          }]),
          ...
          (0, _babelHelperVueJsxMergeProps2.default)([{
            ...
            on: {
              'click': function click($event) {
                ...
                (_$parent2 = _this3.$parent).next.apply(_$parent2, [$event].concat(attrs));
              }
            }
          }]),
          ...
          [h(
            ...
            (0, _babelHelperVueJsxMergeProps2.default)([{
              ...
              on: {
                'input': function input($event) {
                  ...
                  _this4.handleChange.apply(_this4, [$event].concat(attrs));
                }
              }
            }]),
            [this.pageSizes.map(function (item) {
              return h('el-option', {
                attrs: {
                  value: item,
                  label: item + _this4.t('el.pagination.pagesize') }
              });
            })]
          )]
        );
    ...
    Jumper: {
      ...
      watch: {
        '$parent.internalPageSize': function $parentInternalPageSize() {
          ...
          this.$nextTick(function () {
            _this5.$refs.input.$el.querySelector('input').value = _this5.$parent.internalCurrentPage;
          });
        }
      },
      ...
      render: function render(h) {
        ...
        return h(
          ...
          [this.t('el.pagination.goto'), h('el-input', (0, _babelHelperVueJsxMergeProps2.default)([{
            ...
            on: {
              'change': function change($event) {
                ...
                _this6.handleChange.apply(_this6, [$event].concat(attrs));
              },
              'focus': function focus($event) {
                ...
                _this6.handleFocus.apply(_this6, [$event].concat(attrs));
              },
              'blur': function blur($event) {
                ...
                _this6.handleBlur.apply(_this6, [$event].concat(attrs));
              }
            }
  ...
  methods: {
    ...
    emitChange: function emitChange() {
      ...
      this.$nextTick(function () {
        if (_this7.internalCurrentPage !== _this7.lastEmittedPage || _this7.userChangePageSize) {
          _this7.$emit('current-change', _this7.internalCurrentPage);
          _this7.lastEmittedPage = _this7.internalCurrentPage;
          _this7.userChangePageSize = false;
        }
      });
    }
  },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44448c28_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pager_vue__ = __webpack_require__(138);
